...
type RecurrencesRepo interface {
	Select(ctx context.Context, db utils.Executer) ([]Recurrence, error)
	Insert(ctx context.Context, db utils.Executer, data CreateRecurrenceDTO) error
	Update(ctx context.Context, db utils.Executer, data UpdateRecurrenceDTO) error
