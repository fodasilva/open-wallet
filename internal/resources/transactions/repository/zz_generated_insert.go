...
func (r *TransactionsRepoImpl) Insert(db utils.Executer, data CreateTransactionDTO) error {
...
func (r *EntriesRepoImpl) Insert(db utils.Executer, data CreateEntryDTO) error {
